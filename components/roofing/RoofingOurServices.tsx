...
export default function RoofingOurServices() {
  return (
    <div className="container mx-auto mb-[120px]">
      <div className="flex justify-center">
        <h2 className="text-center text-[46px] text-[#232323] font-bold leading-[66px] max-w-[650px]">
          Our Roofing Services Long Island Include
        </h2>
      </div>
              ...
              <ul className="flex flex-col gap-3">
                <li>
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="text-[#666666]">Roof Repair</div>
                  </div>
                </li>
                <li>
                  <div className="flex items-center gap-2.5">
                    <Checkmark height={15} width={15} />
                    <div className="text-[#666666]">Roof Leak Repair</div>
                  </div>
                </li>
                <li>
                  <div className="flex items-center gap-2.5">
                    <Checkmark height={15} width={15} />
                    <div className="text-[#666666]">Roof Tear Off</div>
                  </div>
                </li>
                <li>
                  <div className="flex items-center gap-2.5">
                    <Checkmark height={15} width={15} />
                    <div className="text-[#666666]">Roof Replacement</div>
                  </div>
                </li>
                <li>
                  <div className="flex items-center gap-2.5">
                    <Checkmark height={15} width={15} />
                    <div className="text-[#666666]">Roof Installation</div>
                  </div>
                </li>
              </ul>
            </div>
